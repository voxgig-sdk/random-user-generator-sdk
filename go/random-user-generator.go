...
// instead of `sdk.NewRandomUserGeneratorSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *RandomUserGeneratorSDK  { return NewRandomUserGeneratorSDK(nil) }
func Test() *RandomUserGeneratorSDK { return TestSDK(nil, nil) }
