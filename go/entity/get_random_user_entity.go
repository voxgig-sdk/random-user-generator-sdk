...
func (e *GetRandomUserEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetRandomUserEntity) Deleted() bool {
	return e.deleted
}
...
// argument it returns the current data as an GetRandomUser; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetRandomUserEntity) DataTyped(data ...GetRandomUser) GetRandomUser {
	if len(data) > 0 {
		return typedFrom[GetRandomUser](e.Data(asMap(data[0])))
	}
	return typedFrom[GetRandomUser](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetRandomUser (all fields
// optional at the wire level).
func (e *GetRandomUserEntity) MatchTyped(match ...GetRandomUser) GetRandomUser {
	if len(match) > 0 {
		return typedFrom[GetRandomUser](e.Match(asMap(match[0])))
	}
	return typedFrom[GetRandomUser](e.Match())
}
...
func (e *GetRandomUserEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
// GetRandomUserListMatch and returns []GetRandomUser. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GetRandomUserEntity) ListTyped(reqmatch GetRandomUserListMatch, ctrl map[string]any) ([]GetRandomUser, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GetRandomUser](res), nil
}
