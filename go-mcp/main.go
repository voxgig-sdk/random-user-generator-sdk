// Command RandomUserGenerator-mcp is an MCP server exposing the RandomUserGenerator
// SDK as MCP tools.
//
// Two tools are registered:
//
//	RandomUserGenerator_list  — list records of an entity
//	RandomUserGenerator_load  — load a single record of an entity
//
