# RandomUserGenerator SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # RandomUserGeneratorSDK.new, not RandomUserGeneratorSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    RandomUserGeneratorSDK.new(opts)
  end
