...
#      offline in seeded test mode (RandomUserGeneratorSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "RandomUserGenerator_sdk.rb")
  SDK_CLASS = "RandomUserGeneratorSDK"
  ...
  SDK_BASE = "RandomUserGenerator_sdk"
