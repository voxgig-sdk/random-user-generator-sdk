...
// RandomUserGenerator SDK utility type

class RandomUserGeneratorUtility
{
    ...
    public static function copy(RandomUserGeneratorUtility $src): RandomUserGeneratorUtility
    {
        $u = new RandomUserGeneratorUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
