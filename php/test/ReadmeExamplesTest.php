...
// RandomUserGenerator SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RandomUserGeneratorSDK::test)
...
{
    private const SDK_CLASS = 'RandomUserGeneratorSDK';
    ...
    private const SDK_BASE = 'randomusergenerator_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../randomusergenerator_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
