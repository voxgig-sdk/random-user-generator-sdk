...
class GetRandomUserEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = RandomUserGeneratorSDK::test($seed, null);
        $seen = iterator_to_array($base->GetRandomUser(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->GetRandomUser(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set RANDOM_USER_GENERATOR_TEST_GET_RANDOM_USER_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function get_random_user_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("RANDOM_USER_GENERATOR_TEST_GET_RANDOM_USER_ENTID");
