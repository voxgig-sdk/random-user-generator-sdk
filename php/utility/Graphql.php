...
// RandomUserGenerator SDK utility: graphql
//
...
class RandomUserGeneratorGraphql
{
    ...
    // equivalent.
    public static function body(RandomUserGeneratorContext $ctx): mixed
    {
    ...
    public static function errors(RandomUserGeneratorContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
