...
class GetRandomUserEntity
{
    ...
    /**
     * @param GetRandomUser|array $args GetRandomUser data (assoc-array) to store.
     */
    ...
    /**
     * @return GetRandomUser|array The current GetRandomUser data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GetRandomUser fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GetRandomUser fields).
     */
    ...
    /**
     * List GetRandomUser items matching the given filter.
     *
     * @param GetRandomUserListMatch|array|null $reqmatch Match filter (any subset
     *   of GetRandomUser fields) as an assoc-array; GetRandomUserListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GetRandomUser[]|array A list of GetRandomUser items as assoc-arrays at
     *   the SDK boundary; throws RandomUserGeneratorError on failure (item-5 convention).
     */
