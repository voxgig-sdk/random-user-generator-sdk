...
// RandomUserGenerator SDK streaming feature
...
class RandomUserGeneratorStreamingFeature extends RandomUserGeneratorBaseFeature
{
    ...
    private function _iterate(RandomUserGeneratorResult $result): \Generator
    {
    ...
    private function _streamable(RandomUserGeneratorContext $ctx): bool
    {
