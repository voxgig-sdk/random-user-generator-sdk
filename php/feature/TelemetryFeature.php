...
// RandomUserGenerator SDK telemetry feature
...
class RandomUserGeneratorTelemetryFeature extends RandomUserGeneratorBaseFeature
{
    ...
    private function _close(RandomUserGeneratorContext $ctx, bool $ok): void
    {
