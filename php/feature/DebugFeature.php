...
// RandomUserGenerator SDK debug feature
...
class RandomUserGeneratorDebugFeature extends RandomUserGeneratorBaseFeature
{
    ...
    private function _finish(RandomUserGeneratorContext $ctx, bool $ok): void
    {
