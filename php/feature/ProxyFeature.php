...
// RandomUserGenerator SDK proxy feature
...
class RandomUserGeneratorProxyFeature extends RandomUserGeneratorBaseFeature
{
    ...
    public function init(RandomUserGeneratorContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RandomUserGeneratorContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
