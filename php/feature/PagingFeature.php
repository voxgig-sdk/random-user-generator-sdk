...
// RandomUserGenerator SDK paging feature
...
class RandomUserGeneratorPagingFeature extends RandomUserGeneratorBaseFeature
{
    ...
    private function _is_list(RandomUserGeneratorContext $ctx): bool
    {
