...
// RandomUserGenerator SDK cache feature
...
class RandomUserGeneratorCacheFeature extends RandomUserGeneratorBaseFeature
{
    ...
    private function _through(RandomUserGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
