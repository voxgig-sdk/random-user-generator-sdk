...
function GetRandomUserEntity:mark_deleted()
  self._deleted = true
end


function GetRandomUserEntity:deleted()
...
function GetRandomUserEntity:stream(action, args, callopts)
...
---@param reqmatch GetRandomUserListMatch
---@param ctrl? table
