...
func registerSDKWords(r *eng.Registry, client *sdk.RandomUserGeneratorSDK) {
...
func runOp(client *sdk.RandomUserGeneratorSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
