...
AQL-driven CLI and REPL for the RandomUserGenerator SDK. Positional arguments are
...
```sh
go build -o random-user-generator-cli ./...
```
...
./random-user-generator-cli load 1 get_random_user
./random-user-generator-cli load '{id:1}' get_random_user
