...
class GetRandomUserEntity extends RandomUserGeneratorEntityBase_1.RandomUserGeneratorEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'get_random_user';
        this.name_ = 'get_random_user';
        this.Name = 'GetRandomUser';
    }
    make() {
        return new GetRandomUserEntity(this._client, this.entopts());
    }
...
exports.GetRandomUserEntity = GetRandomUserEntity;
//# sourceMappingURL=GetRandomUserEntity.js.map