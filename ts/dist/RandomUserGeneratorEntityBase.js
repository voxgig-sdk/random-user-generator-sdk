...
exports.RandomUserGeneratorEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends RandomUserGeneratorEntityBase<Advice>`.
class RandomUserGeneratorEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.RandomUserGeneratorEntityBase = RandomUserGeneratorEntityBase;
//# sourceMappingURL=RandomUserGeneratorEntityBase.js.map