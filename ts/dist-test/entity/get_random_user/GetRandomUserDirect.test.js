...
(0, node_test_1.describe)('GetRandomUserDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.RandomUserGeneratorSDK({
    ...
    (0, node_test_1.test)('direct-list-get_random_user', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-get_random_user', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.RandomUserGeneratorSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['RANDOM_USER_GENERATOR_TEST_GET_RANDOM_USER_ENTID'];
    ...
    const client = new __1.RandomUserGeneratorSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetRandomUserDirect.test.js.map