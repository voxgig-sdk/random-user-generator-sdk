...
|---|---|---|
| `ts/` | @voxgig-sdk/random-user-generator-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/random-user-generator-sdk \
      --repository voxgig-sdk/random-user-generator-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/random-user-generator-sdk` shows it, and
`npm trust revoke @voxgig-sdk/random-user-generator-sdk --id=<id>` removes it.
