...
// RandomUserGenerator SDK audit feature
...
class RandomUserGeneratorAuditFeature extends RandomUserGeneratorBaseFeature
{
    ...
    private function _emit(RandomUserGeneratorContext $ctx, string $outcome): void
    {
