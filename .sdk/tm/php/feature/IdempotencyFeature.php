...
// RandomUserGenerator SDK idempotency feature
...
class RandomUserGeneratorIdempotencyFeature extends RandomUserGeneratorBaseFeature
{
    ...
    private function _mutating(RandomUserGeneratorContext $ctx): bool
    {
