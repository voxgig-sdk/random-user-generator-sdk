...
// RandomUserGenerator SDK rbac feature
...
class RandomUserGeneratorRbacFeature extends RandomUserGeneratorBaseFeature
{
    ...
    private function _required(RandomUserGeneratorContext $ctx): ?string
    {
    ...
    private function _reject(RandomUserGeneratorContext $ctx, string $required): void
    {
    ...
    private function _track(RandomUserGeneratorContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
