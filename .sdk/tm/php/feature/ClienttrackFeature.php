...
// RandomUserGenerator SDK clienttrack feature
...
class RandomUserGeneratorClienttrackFeature extends RandomUserGeneratorBaseFeature
{
    ...
    public function PostConstruct(RandomUserGeneratorContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RandomUserGenerator-SDK';
