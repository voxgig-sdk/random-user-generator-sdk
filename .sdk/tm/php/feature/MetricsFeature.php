...
// RandomUserGenerator SDK metrics feature
...
class RandomUserGeneratorMetricsFeature extends RandomUserGeneratorBaseFeature
{
    ...
    private function _record(RandomUserGeneratorContext $ctx, bool $ok): void
    {
