...
// RandomUserGenerator SDK netsim feature
...
class RandomUserGeneratorNetsimFeature extends RandomUserGeneratorBaseFeature
{
    ...
    private function _simulate(RandomUserGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RandomUserGeneratorContext $ctx, array $applied): void
    {
        $client = $this->client;
