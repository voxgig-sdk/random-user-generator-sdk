...
// RandomUserGenerator SDK ratelimit feature
...
class RandomUserGeneratorRatelimitFeature extends RandomUserGeneratorBaseFeature
{
    ...
    private function _acquire(RandomUserGeneratorContext $ctx): void
    {
    ...
    private function _track(RandomUserGeneratorContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
