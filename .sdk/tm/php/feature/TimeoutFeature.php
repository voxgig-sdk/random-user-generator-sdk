...
// RandomUserGenerator SDK timeout feature
...
class RandomUserGeneratorTimeoutFeature extends RandomUserGeneratorBaseFeature
{
    ...
    private function _with_timeout(RandomUserGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RandomUserGeneratorContext $_ctx, float $ms): void
    {
        $client = $this->client;
