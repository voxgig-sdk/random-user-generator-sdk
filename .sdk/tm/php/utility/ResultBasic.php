...
// RandomUserGenerator SDK utility: result_basic

class RandomUserGeneratorResultBasic
{
    public static function call(RandomUserGeneratorContext $ctx): ?RandomUserGeneratorResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof RandomUserGeneratorError) ? $result->err->msg : (string)$result->err;
