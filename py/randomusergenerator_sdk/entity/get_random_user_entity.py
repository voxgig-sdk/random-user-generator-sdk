...
from randomusergenerator_sdk.randomusergenerator_types import (
    GetRandomUser,
...
class GetRandomUserEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetRandomUserEntity(self._client, opts)
    ...
    def data_get(self) -> GetRandomUser:
    ...
    def match_get(self) -> GetRandomUser:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GetRandomUser]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GetRandomUser().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
