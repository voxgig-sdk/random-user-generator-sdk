...
from randomusergenerator_sdk.utility import register

# Load features
from randomusergenerator_sdk.feature.base_feature import RandomUserGeneratorBaseFeature
from randomusergenerator_sdk.features import _has_feature, _make_feature
...
class RandomUserGeneratorSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = RandomUserGeneratorUtility()
    ...
    def get_utility(self):
        return RandomUserGeneratorUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RandomUserGeneratorSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetRandomUser(self, data=None) -> "GetRandomUserEntity":
        ...
        from randomusergenerator_sdk.entity.get_random_user_entity import GetRandomUserEntity
