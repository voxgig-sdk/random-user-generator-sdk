# RandomUserGenerator SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RandomUserGeneratorSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RandomUserGeneratorSDK(...) and RandomUserGeneratorSDK.test(...) become
#      RandomUserGeneratorSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "randomusergenerator_sdk"
_SDK_CLASS = "RandomUserGeneratorSDK"
