# RandomUserGenerator SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from randomusergenerator_sdk import RandomUserGeneratorSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"RandomUserGeneratorSDK": RandomUserGeneratorSDK, "os": os}
        try:
