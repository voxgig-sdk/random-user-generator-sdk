...
class RandomUserGeneratorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RandomUserGeneratorTestRunner.getenv("RANDOMUSERGENERATOR_TEST_LIVE")
        override = RandomUserGeneratorTestRunner.getenv("RANDOMUSERGENERATOR_TEST_OVERRIDE")
        ...
        explain = RandomUserGeneratorTestRunner.getenv("RANDOMUSERGENERATOR_TEST_EXPLAIN")
