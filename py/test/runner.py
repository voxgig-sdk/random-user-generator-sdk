...
class RandomUserGeneratorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RandomUserGeneratorTestRunner.getenv("RANDOM_USER_GENERATOR_TEST_LIVE")
        override = RandomUserGeneratorTestRunner.getenv("RANDOM_USER_GENERATOR_TEST_OVERRIDE")
        ...
        explain = RandomUserGeneratorTestRunner.getenv("RANDOM_USER_GENERATOR_TEST_EXPLAIN")
...
def entity_data(v):
    return RandomUserGeneratorTestRunner.entity_data(v)
...
def live_client_options():
    return RandomUserGeneratorTestRunner.live_client_options()
