...
The Python SDK for the RandomUserGenerator API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.GetRandomUser()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/random-user-generator-sdk/releases)) or
