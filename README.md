...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/random-user-generator` | `npm install @voxgig-sdk/random-user-generator` |
| Python | `voxgig-sdk-random-user-generator` | `pip install voxgig-sdk-random-user-generator` |
| PHP | `voxgig-sdk/random-user-generator` | `composer require voxgig-sdk/random-user-generator` |
| Golang | `github.com/voxgig-sdk/random-user-generator-sdk/go` | `go get github.com/voxgig-sdk/random-user-generator-sdk/go` |
| Ruby | `voxgig-sdk-random-user-generator` | `gem install voxgig-sdk-random-user-generator` |
| Lua | `voxgig-sdk-random-user-generator` | `luarocks install voxgig-sdk-random-user-generator` |
